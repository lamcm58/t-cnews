        ...
        <div class="row">
            <div class="col-md-10 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" action="{{ route('news.edit', $news['id']) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" name="news_title" class="form-control" placeholder="Tiêu đề" value="{!! $news['news_title'] !!}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea name="news_description" class="form-control" rows="3" placeholder='Mô tả'>{!! $news['news_description'] !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea name="news_content" class="form-control" rows="3" placeholder='Nội dung'>{!! $news['news_content'] !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <select class="form-control" id="cate" name="category" onchange="loadSubCategory()">
                                        ...
                                        <option value="{{ $cate['id'] }}" {{ (isset($cate['id']) && $cate['id'] == $selected_sub_cate['category_id']) ? "selected" : "" }}>{{ $cate['category_name'] }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <select name="news_cate_id" class="form-control" id="subCategory">
                                        ...
                                        @foreach($sub_cate as $sub_cat)
                                            @if($sub_cat['category_id'] == $selected_sub_cate['category_id'])
                                            <option value="{{ $sub_cat['id'] }}" {{ (isset($sub_cat['id']) && $sub_cat['id'] == $news['news_cate_id']) ? "selected" : "" }}>{{ $sub_cat['sub_category_name'] }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div><img alt="" src="{{ asset('image/imageThumbnail') }}/{{ $news['news_image_thumbnail'] }}"></div>
                                    <div class="checkbox">
                                        <label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div><img alt="" src="{{ asset('image/images') }}/{{ $news['news_images'] }}"></div>
                                    <div class="checkbox">
                                        <label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="news_is_hot" {{ $news['news_is_hot'] == 1 ? "checked" : "" }}> Có
                                        </label>
                                    </div>
                                </div>
                            </div>
